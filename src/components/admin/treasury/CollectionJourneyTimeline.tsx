...
const TIMELINE_STAGES = [
  "DIVINE OFFERING BEING PREPARED.",
  "DIVINE OFFERING READY FOR REVIEW.",
  "DIVINE OFFERING BEAUTIFULLY ACCEPTED.",
  "NOW BLESSING THE DIVINE FAMILY OF SHREEJI SEVA BHAV."
];

export default function CollectionJourneyTimeline() {
  const [currentStage, setCurrentStage] = useState(1); // 0-indexed, so 2nd stage is active
  ...
  return (
    <div className="bg-white/70 backdrop-blur-md border border-gold-start/30 rounded-3xl p-8 shadow-sm relative overflow-hidden h-full">
      ...
      <div className="relative pl-4 space-y-10">
        ...
        {TIMELINE_STAGES.map((stage, idx) => {
          ...
          return (
            ...
            >
              <div className="bg-white rounded-full p-1 relative z-10 group-hover:scale-110 transition-transform mt-1">
                {isCompleted ? (
