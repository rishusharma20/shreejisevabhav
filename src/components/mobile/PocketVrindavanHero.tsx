...
export default function PocketVrindavanHero() {
  return (
    <div className="w-full max-w-4xl mx-auto pt-12 pb-16 px-6 relative z-20 text-center">
      ...
      >
        ...
        <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#5C1A1A] tracking-wider mb-8 leading-tight drop-shadow-sm">
          Pocket Of Vrindavan.
        </h1>
        ...
        <p className="font-medium italic text-lg text-charcoal/80 max-w-xl mx-auto">
          "May Shri Radha Raman Ji's divine blessings forever remain upon you."
        </p>
      </motion.div>
    </div>
  );
