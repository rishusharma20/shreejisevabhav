...
export default function ContinueJourneyAcademy() {
  return (
    <div className="w-full max-w-4xl mx-auto mb-16 px-6 relative z-10 text-center border-t border-gold-start/20 pt-16">
      <h3 className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#8B6F4E] mb-8">
        Continue Your Divine Journey
      </h3>
      
      <div className="flex flex-col md:flex-row justify-center items-center gap-y-4 gap-x-8 mb-12">
