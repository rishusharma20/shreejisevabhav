...
export default function DigitalMemorySearch() {
  return (
    <div className="w-full max-w-5xl mx-auto mb-32 px-6 relative z-10 text-center">
      ...
      >
        ...
        <h4 className="font-display text-xl font-bold text-[#8B6F4E] tracking-widest mb-6">
          WONDERFUL NEWS.
        </h4>
        ...
        <div className="font-medium italic text-lg md:text-xl text-charcoal/80 leading-relaxed max-w-xl mx-auto mb-8">
          ...
          <p className="mt-4">
            Would you like to continue your beautiful tradition this year?
          </p>
        </div>
        ...
        >
          ...
          <span className="text-[10px] md:text-xs uppercase tracking-widest font-bold text-[#5C1A1A]">
            125+ DIVINE OFFERINGS WAITING FOR YOU.
          </span>
        </motion.div>
