...
import TreasuryHero from "@/components/admin/treasury/TreasuryHero";
import FestivalCurationSystem from "@/components/admin/treasury/FestivalCurationSystem";
import LiveCollectionAnalytics from "@/components/admin/treasury/LiveCollectionAnalytics";
import DivineCollectionTemple from "@/components/admin/treasury/DivineCollectionTemple";

export default function DivineTreasuryPage() {
  return (
    <main className="w-full">
      ...
      <div className="w-full text-center mb-16 px-6">
        ...
        >
          ...
          <span className="font-display text-lg md:text-xl font-bold text-[#5C1A1A] tracking-widest uppercase">
            The Divine Treasury of Vrindavan
          </span>
          <Sparkles className="w-5 h-5 text-gold-start" />
        </motion.div>
      </div>
      ...
      <TreasuryHero />
      <FestivalCurationSystem />
      <LiveCollectionAnalytics />
      <DivineCollectionTemple />
