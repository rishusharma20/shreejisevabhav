...
import ReserveHero from "@/components/admin/reserve/ReserveHero";
import LiveReserveAnalytics from "@/components/admin/reserve/LiveReserveAnalytics";
import FestivalForecastingAi from "@/components/admin/reserve/FestivalForecastingAi";
import AiDivineGuardian from "@/components/admin/reserve/AiDivineGuardian";
import LiveFestivalReserveMap from "@/components/admin/reserve/LiveFestivalReserveMap";
import DivinePreparationCenter from "@/components/admin/reserve/DivinePreparationCenter";

export default function DivineReservePage() {
  return (
    <main className="w-full">
      ...
      <div className="w-full text-center mb-16 px-6">
        ...
        >
          ...
          <span className="font-display text-lg md:text-xl font-bold text-[#5C1A1A] tracking-widest uppercase">
            The Divine Reserve of Vrindavan
          </span>
          <Sparkles className="w-5 h-5 text-gold-start" />
        </motion.div>
      </div>
      ...
      <ReserveHero />
      <LiveReserveAnalytics />
      <FestivalForecastingAi />
      <AiDivineGuardian />
      <LiveFestivalReserveMap />
      <DivinePreparationCenter />
