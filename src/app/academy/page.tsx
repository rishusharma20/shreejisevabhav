...
import LearnDivineSeva from "@/components/academy/LearnDivineSeva";
import DivineKnowledgeSeries from "@/components/academy/DivineKnowledgeSeries";
import TodaysDivineLearning from "@/components/academy/TodaysDivineLearning";
import CompleteOfferingGuide from "@/components/academy/CompleteOfferingGuide";
import FestivalExperiences from "@/components/academy/FestivalExperiences";
import DivineLearningPaths from "@/components/academy/DivineLearningPaths";
import DivineLibrary from "@/components/academy/DivineLibrary";
import ContinueJourneyAcademy from "@/components/academy/ContinueJourneyAcademy";

export default function DivineAcademyPage() {
  return (
    <main className="min-h-screen w-full bg-[#FFFBF4] relative overflow-hidden pb-12 pt-32">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 mb-4 relative z-50">
        <div className="flex flex-wrap items-center gap-2 text-[9px] uppercase tracking-widest font-bold mb-8">
          ...
          <span className="text-[#5C1A1A]">Divine Seva Academy</span>
        </div>
      </div>
      ...
      <AcademyHero />
      <LearnDivineSeva />
      <DivineKnowledgeSeries />
      <TodaysDivineLearning />
      <CompleteOfferingGuide />
      <FestivalExperiences />
      <DivineLearningPaths />
      <DivineLibrary />
      
      {/* ── RULE NO. 17 & 18: CONTINUE JOURNEY ── */}
      <ContinueJourneyAcademy />
