...
import SangamHero from "@/components/sangam/SangamHero";
import HowMayWeAssist from "@/components/sangam/HowMayWeAssist";
import OfferYourMessage from "@/components/sangam/OfferYourMessage";
import CreatorSangamMessage from "@/components/sangam/CreatorSangamMessage";
import LiveWhatsAppSeva from "@/components/sangam/LiveWhatsAppSeva";
import CustomDivineOfferings from "@/components/sangam/CustomDivineOfferings";
import VisitDivineStreets from "@/components/sangam/VisitDivineStreets";
import SangamTodaysBlessing from "@/components/sangam/SangamTodaysBlessing";
import ContinueJourneySangam from "@/components/sangam/ContinueJourneySangam";

export default function DivineSangamPage() {
  return (
    <main className="min-h-screen w-full bg-[#FFFBF4] relative overflow-hidden pb-12 pt-32">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 mb-4 relative z-50">
        <div className="flex flex-wrap items-center gap-2 text-[9px] uppercase tracking-widest font-bold mb-8">
          ...
          <span className="text-[#5C1A1A]">The Divine Sangam</span>
        </div>
      </div>
      ...
      <HowMayWeAssist />
      <LiveWhatsAppSeva />
      <CustomDivineOfferings />
      <OfferYourMessage />
      <CreatorSangamMessage />
      <VisitDivineStreets />
      <SangamTodaysBlessing />
      
      {/* ── RULE NO. 17 & 19: CONTINUE JOURNEY ── */}
      <ContinueJourneySangam />
